...
if __name__ == '__main__':
    ...
    data = client.get_data('BTCUSDT' , '15min')
    ...
    time = '{hour}:{minute}'.format(hour=4 , minute=30)
    ...
    websocket = AsWebSocketClient(client=client ,nn=neural_network, symbol='BTCUSDT' , time_frame='15min', time=time)
